...
/**
 * This class represents the Rotation Multiplication Hash Table. The class implements
 ...
 *
 */
public class RotationMultiplyHash implements HashTable<String, Integer> {
	...
	private Node[]table;
	/**
	 * This field represents the size of the {@link RotationMultiplyHash}.
	 * The size is given by the constructor {@link #RotationMultiplyHash(int)}.
	 */
	private int size;
	/**
	...
	/**
	 * This is the constructor of {@link RotationMultiplyHash}. Initially,
	 ...
	 */
	public RotationMultiplyHash(int n){
		size = n;
		table = new Node[n];
		usedBuckets = 0;
		longestChain = 0;
	...
	/**
	 * This method adds a {@link Node} to the {@link RotationMultiplyHash}{@link #table}. 
...
//		}
	...
	/**
	 * This method removes the given key from the {@link RotationMultiplyHash}
	 * {@link #table}. If the {@link Node} is linked to the chain it must be looked
	 * for before it is removed.
	 * @param key the key that is being removed from the {@link RotationMultiplyHash} {@link #table}.
	...
	/**
	 * This method finds the key in the {@link RotationMultiplyHash} {@link #table}.
	 * After finding it it returns the value of the {@link Node} if the
	 * {@link Node} is in the table.
	 * @param key the key that is being looked for in the {@link RotationMultiplyHash} {@link #table}.
	 ...
	 * value is then multiplied to the sum.
