...
/**
 * This class represents the Multiplication Hash Table. The class implements
 * the HashTable<String, Integer> interface. This Table differs from
 * the other tables because it Multiplies the values of each letter and gets the 
 * hash by mod of the size.
 * @author Aileen Alba
 *
 */
public class MultiplicationHash implements HashTable <String,Integer>{
	/**
	 * This field represents the size of the {@link MultiplicationHash}.
	 * The size is given by the constructor {@link #MultiplicationHash(int)}.
	 */
	private long size;
	/**
	...
	/**
	 * This is the constructor of {@link MultiplicationHash}. Initially,
	...
	/**
	 * This method adds a {@link Node} to the {@link MultiplicationHash}{@link #table}. 
	...
	/**
	 * This method removes the given key from the {@link MultiplicationHash}
	 * {@link #table}. If the {@link Node} is linked to the chain it must be looked
	 * for before it is removed.
	 * @param key the key that is being removed from the {@link MultiplicationHash} {@link #table}.
	...
	/**
	 * This method finds the key in the {@link MultiplicationHash} {@link #table}.
	 * After finding it it returns the value of the {@link Node} if the
	 * {@link Node} is in the table.
	 * @param key the key that is being looked for in the {@link MultiplicationHash} {@link #table}.
	...
	public void printReport() {
		System.out.println(storedElements + ", " + usedBuckets);
	 ...
	 * multiplying all the values of the letters.
	...
	public void resize(){
		...
		int originalSize = table.length;
		this.table = new Node[(int)(originalSize*1.5)];
